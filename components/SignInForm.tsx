  ...
  return (
    <div className="w-full max-w-md rounded-2xl p-8 shadow-2xl relative overflow-hidden">
      ...
      <div 
        ...
        style={{
          background: 'linear-gradient(180deg, rgba(217,217,217,0.8) 0%, rgba(143,143,143,0.28) 48%, rgba(41,94,93,0.8) 87%, rgba(0,75,73,1) 100%)'
        }}
      ></div>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              <input
                ...
                className="w-4 h-4 text-white border-white rounded focus:ring-white bg-white/60"
              />
