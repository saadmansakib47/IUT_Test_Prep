...
export default function Footer() {
  ...
  const resourceLinks = [
    { href: '/resources/previous-papers', label: 'Previous Year Papers' },
    { href: '/resources/syllabus', label: 'IUT Syllabus' },
    { href: '/resources/study-tips', label: 'Study Tip' },
  ];
  ...
  return (
    <footer className="bg-[#004B49] text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          {/* Brand Section */}
          <div className="lg:col-span-1">
            <h3 className="text-lg font-bold mb-4">IUT TestPrep</h3>
            <p className="text-sm text-white/80 mb-4">
              Empowering IUT aspirants with realistic mock tests, smart analytics, and AI-powered learning tools.
            </p>
            {/* Social Icons */}
      ...
      {/* Copyright Bar */}
      <div className="bg-[#003333] py-4">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <p className="text-sm text-white/80 text-center">
            © {new Date().getFullYear()} IUT PrepMate. All rights reserved. || Language selector || "Accessibility Settings" quick link
          </p>
        </div>
      </div>
    </footer>
